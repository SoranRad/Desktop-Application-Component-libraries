...
{
    public partial class MS_Mother_Mali : Office2007Form
    {
        public MS_Mother_Mali()
        {
            InitializeComponent();
        ...
        private Escap_Exit _Escap = Escap_Exit.No;
        private bool _Esc_Ex = false;
        ...
        private void MS_Mother_Janus_KeyUp(object sender, KeyEventArgs e)
        {
