...
{
    public partial class Form_Notify : MS_Mother_Two
    {
        #region تعریفـات
        ...
        #region سازنده
        public Form_Notify(string Title)
        {
            InitializeComponent();
            Init_Form();
            Text = Title;
        ...
        public Form_Notify(string Title, string Message)
        {
            InitializeComponent();
            Init_Form();
            Text = Title;
        ...
        public Form_Notify(string Title, string Message, FarsiMessageBoxIcon Icon_MSG)
        {
            InitializeComponent();
            Init_Form();
            Text = Title;
        ...
        public Form_Notify(string Title, string Message, System.Drawing.Image Icon_MSG)
        {
            InitializeComponent();
            Init_Form();
            Text = Title;
